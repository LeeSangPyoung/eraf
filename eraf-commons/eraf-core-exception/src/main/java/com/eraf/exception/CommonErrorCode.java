...
public enum CommonErrorCode implements ErrorCode {
    ...
    // Feature Flag Errors
    FEATURE_FLAG_NOT_FOUND("FEATURE_FLAG_NOT_FOUND", "Feature Flag를 찾을 수 없습니다: %s", 404),
    FEATURE_FLAG_ALREADY_EXISTS("FEATURE_FLAG_ALREADY_EXISTS", "이미 존재하는 Feature Flag입니다: %s", 409),
    INVALID_TARGETING_RULES("INVALID_TARGETING_RULES", "타겟팅 규칙 형식이 올바르지 않습니다.", 400),
    INVALID_FALLBACK_VALUE("INVALID_FALLBACK_VALUE", "Fallback 값이 올바르지 않습니다.", 400),
